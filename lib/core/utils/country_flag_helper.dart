/// Utility for converting ISO 3166-1 alpha-2 country codes to flag emojis
/// and providing a list of all countries.
class CountryFlagHelper {
  CountryFlagHelper._();

  /// Converts an ISO 3166-1 alpha-2 code (e.g., "IT") to a flag emoji (e.g., "🇮🇹").
  /// Uses Unicode regional indicator symbols.
  static String getFlag(String isoCode) {
  ...
  /// Reverse lookup: find ISO code from country name.
  static String? getCodeFromName(String name) {
    final lower = name.toLowerCase();
    for (final c in allCountries) {
      if (c.name.toLowerCase() == lower) return c.isoCode;
    }
    return null;
  }

  /// All 198 countries sorted alphabetically.
