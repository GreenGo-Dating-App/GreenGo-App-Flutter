...
class MembershipRulesModel extends MembershipRules {
  const MembershipRulesModel({
    ...
    super.dailyPriorityConnectLimit,
    super.hourlyConnectLimit,
    super.hourlyPassLimit,
    super.hourlyPriorityConnectLimit,
  ...
  factory MembershipRulesModel.fromJson(Map<String, dynamic> json) {
    return MembershipRulesModel(
      ...
      dailyPriorityConnectLimit: json['dailyPriorityConnectLimit'] as int? ?? 0,
      hourlyConnectLimit: json['hourlyConnectLimit'] as int? ?? 5,
      hourlyPassLimit: json['hourlyPassLimit'] as int? ?? 10,
      hourlyPriorityConnectLimit: json['hourlyPriorityConnectLimit'] as int? ?? 0,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'dailyPriorityConnectLimit': dailyPriorityConnectLimit,
      'hourlyConnectLimit': hourlyConnectLimit,
      'hourlyPassLimit': hourlyPassLimit,
      'hourlyPriorityConnectLimit': hourlyPriorityConnectLimit,
