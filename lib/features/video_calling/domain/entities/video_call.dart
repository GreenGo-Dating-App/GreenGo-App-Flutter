...
class VideoCall extends Equatable {
  ...
  const VideoCall({
    ...
    required this.callMetrics, this.answeredAt,
    this.endedAt,
    this.duration,
    this.quality,
...
class NetworkStats extends Equatable { // percentage
...
class CallRecording extends Equatable {
  ...
  const CallRecording({
    ...
    required this.fileSizeMB, required this.consentGiven, required this.participants, this.endedAt,
    this.duration,
    this.storageUrl,
  });
...
class CallHistoryEntry extends Equatable {
  ...
  const CallHistoryEntry({
    ...
    required this.type, required this.status, required this.timestamp, required this.wasIncoming, this.otherUserName,
...
class VideoCallFeatures extends Equatable { // Point 138
...
class VirtualBackground extends Equatable { // 0-100
...
class ARFilter extends Equatable {
  ...
  const ARFilter({
    ...
    required this.name,
    required this.type, this.iconUrl,
  });
...
class BeautyMode extends Equatable { // 0-100
...
class CallFeedback extends Equatable {
  ...
  const CallFeedback({
    ...
    required this.submittedAt, this.comments,
  });
...
class GroupVideoCall extends Equatable { // Point 145

  const GroupVideoCall({
    required this.callId,
    required this.hostUserId,
    required this.participants,
    required this.initiatedAt, required this.status, this.maxParticipants = 6,
...
class BreakoutRoom extends Equatable {
  ...
  const BreakoutRoom({
    ...
    required this.createdAt, this.hostId,
  });
  final String roomId;
  final String name;
