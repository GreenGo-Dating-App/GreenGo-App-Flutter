...
class ProfileModel extends Profile {
  ...
  factory ProfileModel.fromJson(Map<String, dynamic> json) {
    return ProfileModel(
      ...
      primaryOrigin: json['primaryOrigin'] as String?,
      secondaryOrigin: json['secondaryOrigin'] as String?,
      ...
      businessLegalName: json['businessLegalName'] as String?,
...
class LocationModel extends Location {
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      'city': city,
      'country': normalized,
      'countryLower': normalized.toLowerCase(),
      'displayAddress': displayAddress,
    };
  }
}

/// Normalizes locale-dependent country names to English standard names.
/// Geocoding APIs return country names in the device locale (e.g., "Italia"
/// instead of "Italy", "Deutschland" instead of "Germany"). This map ensures
/// all stored country names match the English names used in the filter UI.
String normalizeCountryName(String country) {
  return _countryNormalizationMap[country.toLowerCase()] ?? country;
}

final Map<String, String> _countryNormalizationMap = {
  // Italian locale
  'italia': 'Italy',
  ...
  'marrocos': 'Morocco',
  'tunísia': 'Tunisia',
  // English variants (ensure lowercase English maps correctly)
