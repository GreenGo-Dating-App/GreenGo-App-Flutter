...
class MembershipRulesModel {
  ...
  static MembershipRules fromMap(Map<String, dynamic> map) {
    return MembershipRules(
      ...
      canSeeWhoLiked: map['canSeeWhoLiked'] as bool? ?? false,
      ...
      canBoostProfile: map['canBoostProfile'] as bool? ?? false,
      monthlyFreeBoosts: map['monthlyFreeBoosts'] as int? ?? 0,
      canUndoSwipe: map['canUndoSwipe'] as bool? ?? false,
