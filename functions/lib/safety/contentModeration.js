...
exports.moderateChatImage = exports.detectScam = exports.detectFakeProfile = exports.detectSpam = exports.moderateText = exports.moderatePhoto = void 0;
...
exports.moderatePhoto = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        labels.forEach((label) => {
            if (nudityLabels.some((nudityLabel) => label.description.toLowerCase().includes(nudityLabel)) && (label.score || 0) > 0.5) {
                violations.push({
                    type: 'nudity',
        ...
        labels.forEach((label) => {
            if (offensiveLabels.some((offensive) => label.description.toLowerCase().includes(offensive))) {
                violations.push({
...
exports.moderateText = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const sentimentMagnitude = ((_b = sentiment.documentSentiment) === null || _b === void 0 ? void 0 : _b.magnitude) || 0;
        // Classify content
...
exports.detectFakeProfile = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        // Check account age
        const accountAge = Date.now() - ((_a = userData.createdAt) === null || _a === void 0 ? void 0 : _a.toDate().getTime());
        ...
        const photoCount = ((_b = userData.photos) === null || _b === void 0 ? void 0 : _b.length) || 0;
        if (photoCount === 0) {
            fakeScore += 0.3;
        }
        ...
        const messageTexts = messagesSent.docs.map((doc) => doc.data().message);
    ...
    try {
        ...
        if (!isApproved) {
            ...
            try {
                ...
                const filePath = decodeURIComponent(((_a = urlPath.split('/o/')[1]) === null || _a === void 0 ? void 0 : _a.split('?')[0]) || '');
                if (filePath) {
...
async function createModerationQueueEntry(params) {
    await firestore.collection('moderation_queue').add(Object.assign(Object.assign({}, params), { addedAt: admin.firestore.FieldValue.serverTimestamp(), assignedTo: null, status: 'pending' }));
}
/**
