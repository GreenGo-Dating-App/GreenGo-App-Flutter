...
exports.SecurityAuditSuite = void 0;
...
class SecurityAuditSuite {
            ...
            test: async () => {
                ...
                usersWithLocation.forEach(doc => {
                    ...
                    if (data.location && data.location.latitude && data.location.longitude) {
                        ...
                        const latPrecision = ((_a = data.location.latitude.toString().split('.')[1]) === null || _a === void 0 ? void 0 : _a.length) || 0;
                        if (latPrecision > 2) {
                            preciseLocations++;
                        }
                    }
     ...
     * CATEGORY 8: INFRASTRUCTURE SECURITY (30 TESTS)
     */
    addInfrastructureSecurityTests() {
        for (let i = 1; i <= 30; i++) {
            this.addTest({
    ...
    generateReport(results) {
        ...
        const failedTestsDetails = results
        ...
        const summary = this.generateSummary(totalTests, passedTests, failedTests, criticalIssues, highIssues);
        return {
            timestamp: new Date(),
            totalTests,
            passedTests,
     ...
     */
    generateSummary(total, passed, failed, critical, high) {
...
exports.SecurityAuditSuite = SecurityAuditSuite;
//# sourceMappingURL=security_test_suite.js.map