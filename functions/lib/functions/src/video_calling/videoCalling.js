...
exports.initiateVideoCall = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const callData = {
            ...
            callerPhotoUrl: ((_a = callerData.photoUrls) === null || _a === void 0 ? void 0 : _a[0]) || null,
            receiverName: receiverData.displayName,
            receiverPhotoUrl: ((_b = receiverData.photoUrls) === null || _b === void 0 ? void 0 : _b[0]) || null,
        ...
        await sendCallNotification(receiverId, {
            callId: callRef.id,
            callerName: callerData.displayName,
            callerPhotoUrl: (_c = callerData.photoUrls) === null || _c === void 0 ? void 0 : _c[0],
            callType,
        });
    ...
    try {
        ...
        await Promise.all([
            firestore.collection('users').doc(callData.callerId)
                .collection('call_history').doc(callId).set(Object.assign(Object.assign({}, historyEntry), { otherUserId: callData.receiverId, otherUserName: callData.receiverName, otherUserPhotoUrl: callData.receiverPhotoUrl, direction: 'outgoing' })),
            firestore.collection('users').doc(callData.receiverId)
                .collection('call_history').doc(callId).set(Object.assign(Object.assign({}, historyEntry), { otherUserId: callData.callerId, otherUserName: callData.callerName, otherUserPhotoUrl: callData.callerPhotoUrl, direction: 'incoming' })),
        ]);
        // Update user call status
        await Promise.all([
 ...
 */
async function generateAgoraToken(channelName, userId) {
 ...
 */
async function updateCallStatistics(userId, callData) {
    try {
        ...
        if (!statsDoc.exists) {
            ...
            await statsRef.update({
                ...
                missedCalls: admin.firestore.FieldValue.increment(callData.status === 'declined' || callData.status === 'missed' ? 1 : 0),
