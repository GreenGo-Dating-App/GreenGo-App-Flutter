...
exports.generateVideoThumbnail = exports.processUploadedVideo = void 0;
 ...
 */
exports.processUploadedVideo = functions
    ...
    try {
        ...
        // Optimize thumbnail
        await (0, sharp_1.default)(thumbFilePath)
        ...
        await bucket.upload(thumbFilePath + '.optimized.jpg', {
            ...
            metadata: {
                ...
                metadata: {
                    ...
                    videoWidth: ((_a = metadata.width) === null || _a === void 0 ? void 0 : _a.toString()) || '0',
                    videoHeight: ((_b = metadata.height) === null || _b === void 0 ? void 0 : _b.toString()) || '0',
                    videoDuration: ((_c = metadata.duration) === null || _c === void 0 ? void 0 : _c.toString()) || '0',
                },
            },
        });
        // Get thumbnail URL
    ...
    return new Promise((resolve, reject) => {
        ffmpeg.ffprobe(filePath, (err, metadata) => {
            ...
            resolve({
                ...
                width: (videoStream === null || videoStream === void 0 ? void 0 : videoStream.width) || 0,
                height: (videoStream === null || videoStream === void 0 ? void 0 : videoStream.height) || 0,
