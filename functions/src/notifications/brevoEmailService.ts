...
function getDefaultTemplate(trigger: EmailTrigger, variables: Record<string, any>): { subject: string; htmlContent: string } {
  ...
  const templates: Record<EmailTrigger, { subject: string; htmlContent: string }> = {
    ...
    coupon_redeemed: {
      ...
      htmlContent: baseTemplate(
        'Coupon Redeemed!',
        `<p style="color: ${branding.mutedColor}; line-height: 1.6;">Your coupon code <strong style="color: ${branding.textColor}; font-family: monospace; letter-spacing: 1px;">${variables.couponCode || ''}</strong> has been applied to your account.</p>
        <div style="background: ${branding.backgroundColor}; border-radius: 12px; padding: 20px; margin: 20px 0; border-left: 4px solid ${branding.primaryColor};">
        ...
        <p style="color: ${branding.mutedColor}; line-height: 1.6;">Open the app to enjoy your new perks.</p>`,
        'https://greengo.app',
        'Open GreenGo'
      ),
    },
