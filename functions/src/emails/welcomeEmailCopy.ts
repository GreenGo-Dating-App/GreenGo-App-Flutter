...
const EN: WelcomeEmailCopy = {
  ...
  profilePrompt:
    'Your account has been created successfully. Complete your profile to start connecting with people from every culture.',
...
const COPY: Record<string, WelcomeEmailCopy> = {
  en: EN,
  ...
  it: {
    ...
    profilePrompt:
      'Il tuo account è stato creato con successo. Completa il profilo per iniziare a connetterti con persone di ogni cultura.',
  ...
  es: {
    ...
    profilePrompt:
      'Tu cuenta se ha creado correctamente. Completa tu perfil para empezar a conectar con personas de todas las culturas.',
  ...
  pt: {
    ...
    profilePrompt:
      'A sua conta foi criada com sucesso. Complete o seu perfil para começar a ligar-se a pessoas de todas as culturas.',
  ...
  pt_BR: {
    ...
    profilePrompt:
      'Sua conta foi criada com sucesso. Complete seu perfil para começar a se conectar com pessoas de todas as culturas.',
  ...
  fr: {
    ...
    profilePrompt:
      'Votre compte a bien été créé. Complétez votre profil pour commencer à échanger avec des personnes de toutes les cultures.',
  ...
  de: {
    ...
    profilePrompt:
      'Dein Konto wurde erfolgreich erstellt. Vervollständige dein Profil, um mit Menschen aus allen Kulturen in Kontakt zu kommen.',
 ...
 */
export function welcomeEmailCopy(locale?: unknown): WelcomeEmailCopy {
